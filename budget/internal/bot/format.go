...
// nbsp — неразрывный пробел U+00A0: «1 200 ₽» не должно рваться переносом
// строки посреди суммы. Обычный пробел выглядит в коде так же, и подменить
// его незаметно — легче лёгкого, поэтому он задан кодом символа.
const nbsp = "\u00a0"
