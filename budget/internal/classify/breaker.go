...
// breakerThreshold — сколько подряд ошибок сервиса открывают breaker.
...
// добора в сеть не ходят вообще, а сразу уходят в деградированный путь.
type Breaker struct {
...
// State отдаёт состояние для команды /лимит. Пока не отработала пробная
